import { E as inject, G as useTemplateRef, I as openBlock, K as watch, N as onMounted, O as mergeDefaults, P as onUnmounted, S as getCurrentInstance, St as __exportAll, W as useModel, Y as withCtx, _ as createElementBlock, b as createVNode, et as isProxy, ft as toRefs, h as createBlock, ht as unref, i as render, k as mergeModels, lt as shallowRef, m as createBaseVNode, nt as isRef, p as computed, rt as markRaw, tt as isReactive, ut as toRaw, x as defineComponent } from "./vue.runtime.esm-bundler-B_pudHEa.js";
import { t as OccurrenceActions_default } from "./OccurrenceActions-D_M1pDVE.js";
import { $ as _combineAttributesAndGridOptions, J as RowApiModule, K as ALWAYS_SYNC_GLOBAL_EVENTS, Q as _PUBLIC_EVENT_HANDLERS_MAP, X as _GET_ALL_GRID_OPTIONS, Y as VanillaFrameworkOverrides, Z as _GET_SHALLOW_GRID_OPTIONS, et as _error, it as createGrid, nt as _registerModule, q as BaseComponentWrapper, rt as _warn, tt as _processOnChange } from "./app-BF-ImWg4.js";
import { t as Card_default } from "./Card-CmPAyxh4.js";
import { t as OccurrenceBadge_default } from "./OccurrenceBadge-BXeE8yn5.js";
//#region node_modules/ag-grid-vue3/dist/main.mjs
var q = Object.defineProperty;
var $ = (s, t, o) => t in s ? q(s, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: o
...
var D = class D {
	static getComponentDefinition(t, o) {
		let e;
		return typeof t == "string" ? e = this.searchForComponentInstance(o, t) : e = { extends: defineComponent({ ...t }) }, e || _error(114, { component: t }), e.extends ? (e.extends.setup && (e.setup = e.extends.setup), e.extends.props = this.addParamsToProps(e.extends.props)) : e.props = this.addParamsToProps(e.props), e;
	}
	static addParamsToProps(t) {
		return !t || Array.isArray(t) && t.indexOf("params") === -1 ? t = ["params", ...t || []] : typeof t == "object" && !t.params && (t.params = { type: Object }), t;
	}
	static createAndMountComponent(t, o, e, p) {
		const r = D.getComponentDefinition(t, e);
		if (!r) return;
		const { vNode: a, destroy: i, el: n } = this.mount(r, { params: Object.freeze(o) }, e, p || {});
		return {
	...
	static searchForComponentInstance(t, o, e = 10, p = !1) {
		...
		for (; !a && n && n.components && ++i < e;) n.components && n.components[o] && (a = n.components[o]), n = n.parent;
...
var ye = class extends BaseComponentWrapper {
	...
	createWrapper(o) {
		...
		class p extends Ce {
			...
			callMethod(i, n) {
				...
				if (c[i]) return c[i].apply(l, n);
				{
					const C = ((f = l.$.exposed) == null ? void 0 : f[i]) || ((S = l.exposed) == null ? void 0 : S[i]) || l.$.setupState[i];
	...
	createComponent(o, e) {
		return R.createAndMountComponent(o, e, this.parent, this.provides);
	}
...
var me = class extends VanillaFrameworkOverrides {
	...
	frameworkComponent(o, e) {
		let p = R.searchForComponentInstance(this.parent, o, 10, !0) ? o : null;
		if (!p && e && e[o]) {
			const r = e[o];
			p = R.searchForComponentInstance(this.parent, r, 10, !0) ? r : null;
		}
		return p;
	}
...
function Re(s) {
	if (!s || typeof s != "object" || Array.isArray(s)) return !1;
...
function w(s) {
	...
	const t = /* @__PURE__ */ new WeakSet(), o = (e) => {
		...
		if (isRef(e)) return o(e.value);
		if (isReactive(e) || isProxy(e)) return o(toRaw(e));
		if (Re(e)) return toRaw(e);
		if (Array.isArray(e)) {
			let a = !1;
			for (let i = 0; i < e.length; i++) {
				const n = e[i];
				if (n !== null && typeof n == "object") {
					if (isRef(n) || isReactive(n) || isProxy(n)) {
						a = !0;
						break;
					}
					a = !0;
		...
		for (let a = 0; a < p.length; a++) r[p[a]] = o(e[p[a]]);
		return r;
	};
	return o(s);
}
var fe = { ref: "root" }, De = /* @__PURE__ */ defineComponent({
	__name: "AgGridVue",
	...
	setup(s, { expose: t, emit: o }) {
		const e = s, p = useTemplateRef("root"), r = shallowRef(void 0), a = shallowRef(!1), i = shallowRef(!1), n = shallowRef(!1);
		let l = {}, c = !1;
		const f = toRefs(e), S = new Set(_GET_SHALLOW_GRID_OPTIONS());
		...
		const C = /* @__PURE__ */ new Set([
			...
			"cellValueChanged",
			"rowValueChanged"
		]), P = useModel(s, "modelValue"), B = shallowRef(!1), h = shallowRef(!1), W = o;
		watch(P, (d, u) => {
			a.value && (h.value || (B.value = !0, x("rowData", w(d), w(u))), h.value = !1);
		}, { deep: !0 });
		const T = we(() => {
			h.value = !0, W("update:modelValue", U());
		}, 10), b = getCurrentInstance(), N = (d) => {
			var u, v;
			...
			const d = [];
			return r?.value.forEachLeafNode((u) => {
				d.push(u.data);
			}), d;
		}, O = (d) => (u) => {
			if (i.value) return;
			...
			if (a.value) {
				...
				d === "rowData" && g != null && (g = w(g)), l[d] = g, c || (c = !0, queueMicrotask(() => {
					c = !1, !i.value && r.value && _processOnChange(l, r.value), l = {};
				}));
			}
		}, j = () => Object.create(getCurrentInstance().provides);
		return onMounted(() => {
			_registerModule(RowApiModule, void 0, !0);
			const d = new ye(getCurrentInstance(), j()), u = {
				globalListener: O(),
				globalSyncListener: O(!0),
				frameworkOverrides: new me(getCurrentInstance()),
				providedBeanInstances: { frameworkCompWrapper: d },
				modules: e.modules
			}, v = markRaw(_combineAttributesAndGridOptions(w(e.gridOptions), e, [..._GET_ALL_GRID_OPTIONS(), ...Object.values(_PUBLIC_EVENT_HANDLERS_MAP)])), g = _();
			g !== void 0 && (B.value = !0, v.rowData = w(g)), r.value = createGrid(p.value, v, u), a.value = !0;
		}), onUnmounted(() => {
			var d;
			a.value && (T.cancel(), (d = r == null ? void 0 : r.value) == null || d.destroy(), i.value = !0);
		}), t({ api: r }), (d, u) => (openBlock(), createElementBlock("div", fe, null, 512));
	}
});
//#endregion
//#region resources/js/pages/utils/dateFormater.ts
...
//#endregion
//#region resources/js/pages/occurrences/components/list/OccurrencesTable.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1 = { class: "p-2 sm:p-4" };
var _hoisted_2 = {
...
var OccurrencesTable_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	__name: "OccurrencesTable",
	props: { items: {} },
	setup(__props) {
		const props = __props;
		const occurrences = computed(() => props.items ?? []);
		const selectedOccurrence = inject("selectedOccurrence");
		const editModalOpen = inject("editModalOpen");
		const deleteModalOpen = inject("deleteModalOpen");
		const handleEdit = (item) => {
			if (!selectedOccurrence || !editModalOpen) return;
			selectedOccurrence.value = item;
			editModalOpen.value = true;
		};
		const handleDelete = (item) => {
			if (!selectedOccurrence || !deleteModalOpen) return;
			selectedOccurrence.value = item;
		...
		const colDefs = computed(() => [
			...
			},
			{
				...
				flex: 1,
				minWidth: 140,
				cellRenderer: OccurrenceBadge_default
			},
			{
				headerName: "Ações",
				width: 100,
				sortable: false,
				filter: false,
				cellRenderer: OccurrenceActions_default,
				cellRendererParams: {
					onEdit: handleEdit,
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(Card_default, { class: "overflow-hidden border shadow-sm" }, {
				default: withCtx(() => [createBaseVNode("div", _hoisted_1, [createBaseVNode("div", _hoisted_2, [createVNode(unref(De), {
					class: "h-full w-full",
					rowData: occurrences.value,
...
//#endregion
//#region resources/js/pages/occurrences/components/list/OccurrencesTable.vue
var OccurrencesTable_exports = /* @__PURE__ */ __exportAll({ default: () => OccurrencesTable_default });
var OccurrencesTable_default = OccurrencesTable_vue_vue_type_script_setup_true_lang_default;
//#endregion
export { OccurrencesTable_exports as n, OccurrencesTable_default as t };
